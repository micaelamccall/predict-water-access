...
ggplot(for_plot, aes(x=Value,y=`Life expectancy at birth, total (years)`,group=Measure))+
  ...
  theme(axis.title.x = element_text(size=10), legend.title = element_text(size = 10), legend.text = element_text(size=8), legend.position=c(.5,-.4),  plot.margin = unit(c(.5, 1, 4, 1), "cm"))
